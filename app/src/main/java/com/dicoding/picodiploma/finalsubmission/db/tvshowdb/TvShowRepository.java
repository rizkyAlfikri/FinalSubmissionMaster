...
public class TvShowRepository {
    ...
    private MutableLiveData<List<TvShowResults>> listPopularTv;
    private MutableLiveData<List<TvShowResults>> listTvTop;
    private MutableLiveData<List<TvShowResults>> listTvAir;
    private MutableLiveData<List<TvShowGenres>> listTvGenre;
    private MutableLiveData<TvShowDetail> listTvDetail;
    private MutableLiveData<List<TvShowResults>> listTvQuery;
    private MutableLiveData<List<TvShowTrailer>> listTvTrailer;
    private MutableLiveData<List<TvShowReview>> listTvReview;
    ...
    public MutableLiveData<List<TvShowGenres>> getTvGenre() {
        if (listTvGenre == null) {
            listTvGenre = new MutableLiveData<>();
    ...
    public MutableLiveData<TvShowDetail> getTvDetail(int tvId) {
        if (listTvDetail == null) {
            listTvDetail = new MutableLiveData<>();
    ...
    public MutableLiveData<List<TvShowResults>> getTvQuery(String query, int page) {
        if (listTvQuery == null) {
            listTvQuery = new MutableLiveData<>();
    ...
    public MutableLiveData<List<TvShowTrailer>> getTvTrailer(int tvId) {
        if (listTvTrailer == null) {
            listTvTrailer = new MutableLiveData<>();
    ...
    public MutableLiveData<List<TvShowReview>> getTvReview(int tvId) {
        if (listTvReview == null) {
            listTvReview = new MutableLiveData<>();
